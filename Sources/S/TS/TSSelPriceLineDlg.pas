...
begin
  ...
  else if RadioButtonPRICEMETHOD1.Checked then
  begin
    f_NValue := 1;
  end
  else if RadioButtonPRICEMETHOD2.Checked then
  begin
    f_NValue := 2;
  end
  else if RadioButtonPRICEMETHOD3.Checked then
  begin
    f_NValue := 3;
  end;
