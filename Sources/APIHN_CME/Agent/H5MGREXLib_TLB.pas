...
// $Rev: 16059 $
// File generated on 2014-01-10 오후 3:37:52 from Type Library described below.

// ************************************************************************  //
// Type Lib: c:\Hi5ProGF\exe\H5MgrEx.ocx (1)
// LIBID: {7A5992FB-9FA5-4C7F-8B4B-83E3396EF6BD}
// LCID: 0
// Helpfile: c:\Hi5ProGF\exe\H5MgrEx.hlp
...
// *********************************************************************//
  ...
  public
    ...
    function GetServerIP(AType:Integer) : String;
    function GetEncript(ASource:String; AKey:String; AType:Integer):String;
...
uses ComObj, SysUtils, H5MGREXLib_Const;
...
function TH5MgrEx.GetServerIP(AType: Integer): String;
var
    f_Buffer:Array [0..256] of AnsiChar;
begin
    HFCommand(hf_SIP, Integer(Addr(f_Buffer[0])), AType);

    Result := f_Buffer;
end;

function TH5MgrEx.GetEncript(ASource:String; AKey:String; AType:Integer):String;
var
    f_Buffer:Array [0..63] of AnsiChar;
    f_Value:String;
begin
	f_Value := Format('%s'#$9'%s', [ASource, AKey]);
    StrPCopy(f_Buffer, AnsiString(f_Value));
	HFCommand(hf_ENCRIPT, Integer(Addr(f_Buffer[0])), AType);
