...
uses
  Contnrs, SysUtils, StrUtils, Classes, SyncObjs, Forms, ExtCtrls, Windows,
  Messages,
  FNDefine, FNThread, FNQueue, FNDataSet, FNDataDelivery,
  FNDataObject, FNPOTCollection;
...
uses
  FNSocketManager, FNGlobal, FNCMVariable, MXVariable;
