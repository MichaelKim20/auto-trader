...
{$ENDIF}
    ...
    AOption.SetIntegerValue('REGULAR_STOP_TIME'    ,   Trunc(EncodeTime(22, 30, 0, 0) * 86400000 + 0.5));
...
begin
    if m_SymbolItem = ASymbolItem then exit;
...
begin
    ...
    if Assigned(m_ChangedGabOption) then m_ChangedGabOption(Self);
end;
