...
type
  /// /////////////////////////////////////////////////////////////////////////
  //
  CMKAVLine = class(CMKAVDrawingObject)
  private
    m_X1Date: TDateTime;
    m_X2Date: TDateTime;
    m_X1: Double;
...
// ---------------------------------------------------------------------------
procedure CMKAVLine.ClearText;
begin

end;

// ---------------------------------------------------------------------------
procedure CMKAVLine.XValueToDate;
begin
  if (m_X1 >= 0) then
...
// ---------------------------------------------------------------------------
procedure CMKAVLine.XDateToValue;
begin
...
// ---------------------------------------------------------------------------
function CMKAVLine.HitTest(p_X, p_Y: Integer): Boolean;
var
...
// ---------------------------------------------------------------------------
procedure CMKAVLine.OnMouseDown(p_X, p_Y: Integer);
begin
  if (m_Drawing) then
  begin
    m_X1 := GetRealX(p_X);
...
// ---------------------------------------------------------------------------
procedure CMKAVLine.OnMouseUp(p_X, p_Y: Integer);
begin
  if (m_Drawing) then
  begin
    m_X2 := GetRealX(p_X);
...
// ---------------------------------------------------------------------------
procedure CMKAVLine.OnMouseMove(p_X, p_Y: Integer);
begin
...
// ---------------------------------------------------------------------------
procedure CMKAVLine.DrawDefaultLayer(p_Bitmap: TBitmap32);
var
  f_X1, f_X2: Integer;
  f_Y1, f_Y2: Integer;
  f_Label: String;
