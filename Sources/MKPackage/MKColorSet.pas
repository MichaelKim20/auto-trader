...
type
  ...
  public const
    ...
    DRAW_OBJECT_DEFAULT_COLOR: Integer = 47;
...
uses
  MKGlobal, MKConst, FNCMVariable;

// ---------------------------------------------------------------------------
constructor CMKColorSet.Create();
begin
  inherited Create();
...
// ---------------------------------------------------------------------------
destructor CMKColorSet.Destroy();
begin
...
// ---------------------------------------------------------------------------
procedure CMKColorSet.Initialize;
var
  nIndex: Integer;
begin
  m_ColorSetIndex := 1;
...
// ---------------------------------------------------------------------------
procedure CMKColorSet.SetColorSetIndex(p_Value: Integer);
begin
  if (p_Value = CMKConst.COLOR_SET_BLACK) then
  begin
    m_Color[0] := $00F08080;
    m_Color[1] := $008080F0;
    m_Color[2] := $0080F080;
    ...
    m_Alpha[ALPHA_LINE] := TMKGlobal.GetAlphaValue(80);
    m_Alpha[ALPHA_PRICE_LINE] := TMKGlobal.GetAlphaValue(80);
    m_Alpha[ALPHA_VOLUME_LINE] := TMKGlobal.GetAlphaValue(80);
    m_Alpha[ALPHA_MA_LINE] := TMKGlobal.GetAlphaValue(80);
    m_Alpha[ALPHA_COMPARE_LINE] := TMKGlobal.GetAlphaValue(80);
    m_Alpha[ALPHA_LINE] := TMKGlobal.GetAlphaValue(80);
    m_Alpha[ALPHA_DARK_LINE] := TMKGlobal.GetAlphaValue(100);
    m_Alpha[ALPHA_LIGHT_LINE] := TMKGlobal.GetAlphaValue(30);
    m_Alpha[ALPHA_PAXSTYLE_LINE] := TMKGlobal.GetAlphaValue(100);
    m_Alpha[ALPHA_OSC_LINE] := TMKGlobal.GetAlphaValue(80);

    m_Alpha[ALPHA_MAX_LINE] := TMKGlobal.GetAlphaValue(20);
    m_Alpha[ALPHA_MAX_ARROW] := TMKGlobal.GetAlphaValue(100);
    m_Alpha[ALPHA_MIN_LINE] := TMKGlobal.GetAlphaValue(20);
    m_Alpha[ALPHA_MIN_ARROW] := TMKGlobal.GetAlphaValue(100);

    m_Alpha[ALPHA_IMCLOUDE_UP_FILLED] := TMKGlobal.GetAlphaValue(30);
    m_Alpha[ALPHA_IMCLOUDE_DN_FILLED] := TMKGlobal.GetAlphaValue(30);
    m_Alpha[ALPHA_BAND_FILLED] := TMKGlobal.GetAlphaValue(05);

  end
  else if (p_Value = CMKConst.COLOR_SET_WHITE) then
  begin
    m_Color[0] := $00C18A60;
    m_Color[1] := $00DA568B;
    m_Color[2] := $00AF7F08;
    ...
    begin
      m_Color[PRICE_UP_FILLED_COLOR] := $0001A7F3;
      m_Color[PRICE_UP_LINE_COLOR] := $00005DDF;
      m_Color[PRICE_DN_FILLED_COLOR] := $00FF4208;
      m_Color[PRICE_DN_LINE_COLOR] := $00DA0300;

      m_Color[VOLUME_FILLED_COLOR] := $0041C41C;
      m_Color[VOLUME_LINE_COLOR] := $0041C41C;

      m_Color[OSC_UP_FILLED_COLOR] := $004BB1DB;
      m_Color[OSC_UP_LINE_COLOR] := $004BB1DB;
      m_Color[OSC_DN_FILLED_COLOR] := $00DB774C;
      m_Color[OSC_DN_LINE_COLOR] := $00DB774C;

      m_Color[EXIT_BTN_FILLED_COLOR] := $00F8F6F4;
      m_Color[EXIT_BTN_LINE_COLOR] := $00B8B3A0;

      m_Color[PAXSTYLE_UP_LINE] := $000000F0;
      m_Color[PAXSTYLE_EQ_LINE] := $0000F000;
      m_Color[PAXSTYLE_DN_LINE] := $00F00000;

      m_Color[IMCLOUDE_UP_FILLED_COLOR] := $00FF3300;
      m_Color[IMCLOUDE_DN_FILLED_COLOR] := $0066FF99;
    ...
    m_Alpha[ALPHA_LINE] := TMKGlobal.GetAlphaValue(85);
    m_Alpha[ALPHA_PRICE_LINE] := TMKGlobal.GetAlphaValue(85);
    m_Alpha[ALPHA_VOLUME_LINE] := TMKGlobal.GetAlphaValue(85);
    m_Alpha[ALPHA_MA_LINE] := TMKGlobal.GetAlphaValue(85);
    m_Alpha[ALPHA_COMPARE_LINE] := TMKGlobal.GetAlphaValue(85);
    m_Alpha[ALPHA_LINE] := TMKGlobal.GetAlphaValue(85);
    m_Alpha[ALPHA_DARK_LINE] := TMKGlobal.GetAlphaValue(90);
    m_Alpha[ALPHA_LIGHT_LINE] := TMKGlobal.GetAlphaValue(60);
    m_Alpha[ALPHA_PAXSTYLE_LINE] := TMKGlobal.GetAlphaValue(100);
    m_Alpha[ALPHA_OSC_LINE] := TMKGlobal.GetAlphaValue(85);
    ...
    m_Alpha[ALPHA_IMCLOUDE_UP_FILLED] := TMKGlobal.GetAlphaValue(20);
    m_Alpha[ALPHA_IMCLOUDE_DN_FILLED] := TMKGlobal.GetAlphaValue(20);
    m_Alpha[ALPHA_BAND_FILLED] := TMKGlobal.GetAlphaValue(5);
