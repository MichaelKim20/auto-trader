...
type
  ...
  public
    ...
    // 복제한다
    procedure Clone(p_Source: CMKChartData);
  end;
...
// ---------------------------------------------------------------------------
constructor CMKChartData.Create();
begin
  inherited Create();
  m_Virtual := false;
end;
...
// ---------------------------------------------------------------------------
destructor CMKChartData.Destroy();
begin
...
// ---------------------------------------------------------------------------
procedure CMKChartData.Clone(p_Source: CMKChartData);
begin
