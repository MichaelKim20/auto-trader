...
type
    CFNQIndicatorValue = class(TObject)
    public
    m_Name            : String;
    m_Value            : Integer;
...
//---------------------------------------------------------------------------
constructor CFNQIndicatorValue.Create();
begin
    inherited Create();
...
//---------------------------------------------------------------------------
destructor CFNQIndicatorValue.Destroy();
begin
    Finalize();
...
//---------------------------------------------------------------------------
procedure CFNQIndicatorValue.Initialize;
begin
    m_OptionCount       := 0;
    m_OptionLabel       := NIL;
    m_OptionMaximum     := NIL;
...
//---------------------------------------------------------------------------
procedure CFNQIndicatorValue.Finalize();
begin
    m_OptionLabel       := NIL;
    m_OptionMaximum     := NIL;
    m_OptionMinimum     := NIL;
...
procedure CFNQIndicatorValue.SetDefaultValue();
var
    f_Index : Integer;
begin
...
//---------------------------------------------------------------------------
procedure CFNQIndicatorValue.SetOptionCount(f_Count: Integer);
begin
