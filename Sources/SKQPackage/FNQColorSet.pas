...
//---------------------------------------------------------------------------
constructor CFNQColorSet.Create();
begin
    inherited Create();
...
//---------------------------------------------------------------------------
destructor CFNQColorSet.Destroy();
begin
...
//---------------------------------------------------------------------------
procedure CFNQColorSet.Initialize;
var
    nIndex : Integer;
begin
    m_ColorSetIndex := 1;
...
//---------------------------------------------------------------------------
procedure CFNQColorSet.SetColorSetIndex(p_Value: Integer);
begin
    if (p_Value = CFNQConst.COLOR_SET_BLACK) then
    begin
        m_Color[ 0]         := $00F08080;
        m_Color[ 1]         := $008080F0;
        m_Color[ 2]         := $0080F080;
    ...
    else if (p_Value = CFNQConst.COLOR_SET_WHITE) then
    begin
        m_Color[ 0] := $00c18a60;
        m_Color[ 1] := $00da568b;
        m_Color[ 2] := $00af7f08;
