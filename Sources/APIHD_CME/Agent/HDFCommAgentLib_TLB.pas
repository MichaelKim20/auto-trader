...
// $Rev: 52393 $
// File generated on 2015-09-15 오후 9:06:24 from Type Library described below.
...
// *********************************************************************//
  _DHDFCommAgent = dispinterface
    ...
    procedure CommReqMakeCod(const strParam: WideString; bAllMstCode: Integer); dispid 27;
...
// *********************************************************************//
  ...
  public
    ...
    procedure CommReqMakeCod(const strParam: WideString; bAllMstCode: Integer);
...
begin
  ...
  TControlData2(CControlData).FirstEventOfs := UIntPtr(@@FOnGetData) - UIntPtr(Self);
end;
...
procedure THDFCommAgent.CommReqMakeCod(const strParam: WideString; bAllMstCode: Integer);
begin
  DefaultInterface.CommReqMakeCod(strParam, bAllMstCode);
end;
