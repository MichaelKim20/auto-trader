...
uses Windows, SysUtils, Classes, Graphics, Forms, Controls, StdCtrls,
  ...
  FNDataSet,
  FNLoadController, FNLoadItem, OleCtrls, DCPsha1, DCPrc4,
  IdHTTP,
...
type
  ...
  private
    m_LoadItem_USER_0110: CFNLoadItem_USER_0110;
...
begin
  ...
  m_LoadItem_USER_0110 := CFNLoadItem_USER_0110.Create;
  m_LoginController.AddItem(m_LoadItem_USER_0110);
...
begin
  ...
  g_SecUserID := g_MatrixUserID;
  g_SecUserPW := g_MatrixUserPW;
  g_SecCertPW := g_MatrixUserPW;
...
begin
  ...
  m_LoadItem_USER_0110.m_USER_ID := UpperCase(EditUserName.Text);
  m_LoadItem_USER_0110.m_PASSWORD := UpperCase(TMXGlobal.MD5Hash(EditPassword.Text));
  m_LoadItem_USER_0110.m_PGM_CODE := g_PGMCode;
