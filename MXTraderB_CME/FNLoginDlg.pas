...
uses Windows, SysUtils, Classes, Graphics, Forms, Controls, StdCtrls,
  ...
  AgentGlobalVariable, FNLoadController, FNLoadItem, OleCtrls,  IdHTTP,
...
begin
    ...
    begin
        ...
        Button3.Caption := 'Modify Account';
...
begin
    ...
    begin
        ...
        try
            LIniFile.WriteString('CONNECT','HOST_ADDR','210.183.186.15') ;
            LIniFile.WriteString('CONNECT','HOST_PORT','7300') ;
        finally
            LIniFile.Free;
        end;
    end else
    begin
        LIniFile := TIniFile.Create('system\CommsU.ini');
        try
            LIniFile.WriteString('CONNECT','HOST_ADDR','210.183.186.74') ;
            LIniFile.WriteString('CONNECT','HOST_PORT','7300') ;
        finally
            LIniFile.Free;
        end;
